...
- **After step 4**, make sure `Home.md` lists the new feature under "Active features" and links its `Features/` note. Reconcile if an agent forgot. Convention: `.agents/skills/obsidian/resources/knowledge-base.md`.

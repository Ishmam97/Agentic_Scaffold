...
<!-- Populated per project by /greenfield:kickoff, /greenfield:prd, /greenfield:architect, or /brownfield:onboard.
...
_Unconfigured scaffold — no project bound yet. Run `/greenfield:kickoff` or `/brownfield:onboard` to populate this section._
